...
class GraphTransferable implements Transferable, UIResource, Serializable {
    ...
    if (_isRicherFlavor(flavor)) {
      ...
      if (_image != null && _image.getImage() is RenderedImage) {
        if (flavor.equals(DataFlavor.imageFlavor)) {
          ...
          ImageIO.write(_image.getImage() as RenderedImage, "bmp", stream);
  ...
  static init() {
    try {
      ...
      _htmlFlavors[2] = new DataFlavor("text/html;charset=unicode;class=java.io.InputStream");

      _plainFlavors = new List<DataFlavor>(3);
      _plainFlavors[0] = new DataFlavor("text/plain;class=java.lang.String");
      _plainFlavors[1] = new DataFlavor("text/plain;class=java.io.Reader");
      _plainFlavors[2] = new DataFlavor("text/plain;charset=unicode;class=java.io.InputStream");

      _stringFlavors = new List<DataFlavor>(2);
      _stringFlavors[0] = new DataFlavor(DataFlavor.javaJVMLocalObjectMimeType + ";class=java.lang.String");
    ...
    try {
      dataFlavor = new DataFlavor(DataFlavor.javaSerializedObjectMimeType + "; class=graph.swing.util.GraphTransferable");
