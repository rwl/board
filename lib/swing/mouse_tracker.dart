...
class MouseTracker implements MouseListener, MouseMotionListener {
  ...
  void mousePressed(MouseEvent e) {
    ...
    if (this.graphOutline._graphComponent != null && !e.isConsumed() && !e.isPopupTrigger() && (this.graphOutline._finderBounds.contains(e.getPoint()) || this.graphOutline._zoomGesture)) {
      start = e.getPoint();
    }
  }
  ...
  void mouseDragged(MouseEvent e) {
    if (this.graphOutline.isEnabled() && start != null) {
      if (this.graphOutline._zoomGesture) {
        awt.Rectangle bounds = this.graphOutline._graphComponent.getViewport().getViewRect();
        double viewRatio = bounds.getWidth() / bounds.getHeight();

        bounds = new awt.Rectangle(this.graphOutline._finderBounds);
        ...
        this.graphOutline._graphComponent.getHorizontalScrollBar().setValue(this.graphOutline._graphComponent.getHorizontalScrollBar().getValue() + dx);
        this.graphOutline._graphComponent.getVerticalScrollBar().setValue(this.graphOutline._graphComponent.getVerticalScrollBar().getValue() + dy);
      }
    }
  }
  ...
  void mouseReleased(MouseEvent e) {
    if (start != null) {
      if (this.graphOutline._zoomGesture) {
        ...
        final JScrollBar hs = this.graphOutline._graphComponent.getHorizontalScrollBar();
        final double sx;
