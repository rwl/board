...
class Line extends Point2d {
  ...
  double ptLineDistSq(Point2d pt) {
    return new /*Line2D.*/Double(getX(), getY(), _endPoint.getX(), _endPoint.getY()).ptLineDistSq(pt.getX(), pt.getY());
  }
  ...
  double ptSegDistSq(Point2d pt) {
    return new /*Line2D.*/Double(getX(), getY(), _endPoint.getX(), _endPoint.getY()).ptSegDistSq(pt.getX(), pt.getY());
  }
