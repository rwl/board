...
class Constants
{
	 ...
	 */
	static double RAD_PER_DEG = 0.0174532;

	/**
	 * Defines the number of degrees per radian.
	 */
	static double DEG_PER_RAD = 57.2957795;

	/**
	 * Defines the minimum scale at which rounded polylines should be painted.
	 * Default is 0.05.
	 */
	static double MIN_SCALE_FOR_ROUNDED_LINES = 0.05;
	 ...
	 */
	static int MIN_HOTSPOT_SIZE = 8;

	/**
	 * Defines the maximum size in pixels of the portion of the cell which is
	 * to be used as a connectable region. Use 0 for no maximum. Default is 0.
	 */
	static int MAX_HOTSPOT_SIZE = 0;
	 ...
	 */
	static String DEFAULT_FONTFAMILY = "Dialog";

	/**
	 * Defines the default font size. Default is 11.
	 */
	static int DEFAULT_FONTSIZE = 11;

	/**
	 * Defines the default start size for swimlanes. Default is 40.
	 */
	static int DEFAULT_STARTSIZE = 40;
	 ...
	 */
	static bool ABSOLUTE_LINE_HEIGHT = false;
	 ...
	 */
	static double LABEL_SCALE_BUFFER = 0.9;

	/**
	 * Defines the default marker size. Default is 6.
	 */
	static int DEFAULT_MARKERSIZE = 6;
	 ...
	 */
	static String SVG_SHADOWTRANSFORM = "translate(2 3)";
	 ...
	 */
	static double DEFAULT_LABEL_BUFFER = 12.0;
	 ...
	 * 
	 */
	static String STYLE_PORT_CONSTRAINT = "portConstraint";
	...
	*/
	 ...
	 * in <ImageShape>. Possible values are 0 and 1. Default is 0.
	 */
	static String STYLE_FLIPH = "flipH";
	 ...
	 * Default is 0.
	 */
	static String STYLE_FLIPV = "flipV";
	 ...
	 */
	static String STYLE_ENDFILL = "endFill";

	/**
	 * Defines the key for the startFill style. Use 0 for no fill or 1
	 * (default) for fill. (This style is only exported via <mxImageExport>.)
	 */
	static String STYLE_STARTFILL = "startFill";
	 ...
	 */
	static String STYLE_DASH_PATTERN = "dashPattern";
	 ...
	 */
	static String STYLE_AUTOSIZE = "autosize";
	 ...
	 */
	static String STYLE_FOLDABLE = "foldable";
	 ...
	 */
	static String STYLE_EDITABLE = "editable";
	 ...
	 */
	static String STYLE_BENDABLE = "bendable";
	 ...
	 * Graph.isCellMovable.
	 */
	static String STYLE_MOVABLE = "movable";
	 ...
	 */
	static String STYLE_RESIZABLE = "resizable";
	 ...
	 */
	static String STYLE_CLONEABLE = "cloneable";
	 ...
	 */
	static String STYLE_DELETABLE = "deletable";
