	...
	public static PerimeterFunction RhombusPerimeter = new PerimeterFunction()
	{
				...
				Point2d next, boolean orthogonal)
		{
			...
			if (cx == px)
			{
				if (cy > py)
				{
					return new Point2d(cx, y); // top
				}
				else
				{
					return new Point2d(cx, y + h); // bottom
				}
			}
			else if (cy == py)
			{
				if (cx > px)
				{
					return new Point2d(x, cy); // left
				}
				else
				{
					return new Point2d(x + w, cy); // right
				}
			}
				...
				Point2d next, boolean orthogonal)
		{
			...
			if (base)
			{
								...
								.getY())))
				{
					if (vertical)
					{
						result = new Point2d(next.getX(), start.getY());
					}
					else
					{
				...
				else
				{
					...
					{
						result = new Point2d(x, y + h / 2 - w * Math.tan(alpha)
								/ 2);
					}
					else if (direction.equals(Constants.DIRECTION_NORTH))
					{
						result = new Point2d(x + w / 2 + h * Math.tan(alpha)
								/ 2, y + h);
					}
					else if (direction.equals(Constants.DIRECTION_SOUTH))
					{
					...
					{
						result = new Point2d(x + w, y + h / 2 + w
								* Math.tan(alpha) / 2);
					}
				}
			}
			...
			if (orthogonal)
			{
				if (vertical)
				{
					...
					if (px == cx)
					{
						if (py <= y)
						{
							return new Point2d(cx, y);
						}
						else if (py >= y + h)
						{
							return new Point2d(cx, y + h);
						}
					}
					else if (px < x)
					{
						if (py == y + h / 4)
						{
							return new Point2d(x, y + h / 4);
						}
						else if (py == y + 3 * h / 4)
						{
							return new Point2d(x, y + 3 * h / 4);
						}
					}
					else if (px > x + w)
					{
						if (py == y + h / 4)
						{
							return new Point2d(x + w, y + h / 4);
						}
						else if (py == y + 3 * h / 4)
						{
							return new Point2d(x + w, y + 3 * h / 4);
						}
					}
					else if (px == x)
					{
					...
					else if (px > cx)
					{
						...
						else if (py < y + h / 4)
						{
							...
							b = new Point2d(x + (int) (1.5 * w), y
									+ (int) (0.5 * h));
						}
						else if (py > y + 3 * h / 4)
						{
							a = new Point2d(x + (int) (1.5 * w), y
									+ (int) (0.5 * h));
				...
				else
				{
					...
					else if (py < y)
					{
						if (px == x + w / 4)
						{
							return new Point2d(x + w / 4, y);
						}
						else if (px == x + 3 * w / 4)
						{
							return new Point2d(x + 3 * w / 4, y);
						}
					}
					else if (py > y + h)
					{
						if (px == x + w / 4)
						{
							return new Point2d(x + w / 4, y + h);
						}
						else if (px == x + 3 * w / 4)
						{
							return new Point2d(x + 3 * w / 4, y + h);
						}
					}
					else if (py == y)
					{
